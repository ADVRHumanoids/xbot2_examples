#ifndef ROCKET_DEVICE_DRI_H
#define ROCKET_DEVICE_DRI_H
 ...
 */
class RocketDriver : public DeviceDriverTpl<RocketPacket::Rx,
                                            RocketPacket::Tx>
{
 ...
 */
class RocketDriverContainer : public DeviceContainer<RocketDriver>
{
